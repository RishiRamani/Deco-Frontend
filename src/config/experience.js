...
export const sceneTheme = {
  ...
  dialogueBox: {
    ...
    boxShadow: 'shadow-[0_25px_80px_rgba(45,255,154,0.12)]',
    customStyles: {
      speakerClass: 'text-xs uppercase tracking-[0.3em] text-slate-500',
      textClass: 'mt-4 text-base leading-8',
      transcriptClass: 'mt-5 rounded-[1.5rem] border border-[#2DFF9A]/10 bg-[#0B1F18]/10 px-4 py-3 text-sm leading-7 text-slate-700',
      continueClass: 'mt-5 text-right text-xs uppercase tracking-[0.25em] text-slate-500',
      voicePlayerBgClass: 'mt-5 flex items-center gap-3 rounded-lg bg-[#0B1F18]/50 p-3',
      playButtonClass: 'flex-shrink-0 rounded-full bg-[#2DFF9A] hover:bg-[#0CBE69] p-2 transition',

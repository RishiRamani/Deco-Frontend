export default function AboutPage() {
  return (
    <div className="relative flex min-h-[calc(100vh-7rem)] items-center justify-center overflow-hidden px-4 py-4">
      ...
      <section className="glow-pulse relative w-full max-w-4xl overflow-hidden rounded-[2rem] border border-[#2DFF9A]/20 bg-black/60 px-6 py-6 text-center backdrop-blur-sm shadow-[0_0_60px_rgba(45,255,154,0.08)] sm:px-10 sm:py-8">
        ...
        <div className="relative">
          ...
          {/* Title */}
          <div className="mb-4 text-xs uppercase tracking-[0.55em] text-[#2DFF9A]/80 drop-shadow-[0_0_10px_rgba(45,255,154,0.5)]">
            REALITY BREACH
          </div>

          <div className="mx-auto mb-5 h-px max-w-xs bg-gradient-to-r from-transparent via-red-500/70 to-transparent" />
          ...
          <div className="mx-auto max-w-3xl space-y-4 text-[15px] leading-7 text-slate-300/80 sm:text-base sm:leading-8">
            ...
            {/* Critical line */}
            <p
              className="relative py-1 text-xl sm:text-2xl font-bold tracking-[0.12em] text-red-400"
            ...
            {/* Final line */}
            <p
              className="pt-1 text-xl sm:text-2xl font-bold tracking-[0.12em] text-[#2DFF9A] drop-shadow-[0_0_25px_rgba(45,255,154,0.7)]"
              style={{ fontFamily: "Orbitron, sans-serif" }}
            >

export default function EndPage({ onNav }) {
  return (
    <div className="relative h-screen w-screen overflow-hidden bg-black text-center flex items-center justify-center px-4 sm:px-6">
      ...
      <div className="w-full max-w-5xl">
        ...
        {/* TITLE */}
        <h1
          className="text-5xl sm:text-7xl md:text-8xl font-bold text-[#2DFF9A] drop-shadow-[0_0_40px_rgba(45,255,154,0.7)]"
        ...
        {/* Secondary */}
        <div
          className="mt-5 text-2xl sm:text-3xl text-white/90 tracking-wide"
          style={{ fontFamily: "Orbitron, sans-serif" }}
        >
          DECO REMAINS
        </div>
        ...
        {/* Divider */}
        <div className="mx-auto mt-8 h-px w-48 bg-gradient-to-r from-transparent via-[#2DFF9A] to-transparent" />

        {/* System text */}
        <div className="mt-10 space-y-3 text-sm sm:text-base text-slate-400 tracking-[0.3em]">
          <p>SYSTEM COMPLETE • REALITY EXECUTED</p>
          <p>SIMULATION TERMINATED</p>
        </div>

        {/* Footer system bar */}
        <div className="mt-20 text-xs text-slate-500 tracking-[0.25em]">
